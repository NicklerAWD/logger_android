...
import com.nicolasri.util.logger.service.ILogProcessor;
import com.nicolasri.util.logger.R;
import com.nicolasri.util.logger.service.LogProcessor;
...
public class Logger extends ListActivity {
    ...
    private String fileSEED = "logsave";
    ...
    public void onResume() {
        ...
        Log.d("OnResumeLogger","Create a file for the log");
        File f = new File("/mnt/storage/tmp.log");
        if (f.exists()) {
        	Log.d("OnResumeLogger","Delete the file on Exit");
            f.deleteOnExit();
        }
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        case DIALOG_SAVE_ID:
            ...
            presetfilename = fileSEED + String.valueOf(filenumber) + ".txt";
            File file = new File("mnt/storage/", presetfilename );
            while (file.exists())
            {
            	filenumber++;
            	presetfilename = fileSEED + String.valueOf(filenumber) + ".txt";
            	file = new File("mnt/storage/", presetfilename );
            }
            editText.setText(presetfilename);
            builder.setView(v);
    ...
    private void saveResult(String msg) {
        ...
        if (msg.equals("error")) {
            ...
            mail.putExtra(Intent.EXTRA_STREAM, Uri.parse("file:///mnt/storage/tmp.log"));
