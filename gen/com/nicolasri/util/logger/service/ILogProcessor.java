 ...
 * Original file: C:\\Temp\\limo\\Recon Logger\\logger_android\\src\\com\\nicolasri\\util\\logger\\service\\ILogProcessor.aidl
 */
package com.nicolasri.util.logger.service;
public interface ILogProcessor extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.nicolasri.util.logger.service.ILogProcessor
{
private static final java.lang.String DESCRIPTOR = "com.nicolasri.util.logger.service.ILogProcessor";
...
/**
 * Cast an IBinder object into an com.nicolasri.util.logger.service.ILogProcessor interface,
 * generating a proxy if needed.
 */
public static com.nicolasri.util.logger.service.ILogProcessor asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.nicolasri.util.logger.service.ILogProcessor))) {
return ((com.nicolasri.util.logger.service.ILogProcessor)iin);
}
return new com.nicolasri.util.logger.service.ILogProcessor.Stub.Proxy(obj);
}
...
private static class Proxy implements com.nicolasri.util.logger.service.ILogProcessor
{
